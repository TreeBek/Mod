...
public class DiamondHarwoodArmor extends ItemArmor
{
 public String armorNamePrefix;
    public DiamondHarwoodArmor(int par1, EnumArmorMaterial par2EnumArmorMaterial,
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, int slot, int layer)
    {
    	if (stack.toString().contains("leg")){
    		...
    		return "harwoodmod:textures/armor/" + armorNamePrefix + "_2.png";
    	}
    		...
    		if (stack.toString().contains("Leg")){
    			...
    			return "harwoodmod:textures/armor/" + armorNamePrefix + "_2.png";
    				...
    				return "harwoodmod:textures/armor/" + armorNamePrefix + "_1.png";
