...
public class ItemHarwoodDoor extends Item
{
public Block doorBlock;    
    public ItemHarwoodDoor(int par1, Block block)
    {
    super(par1);
...
*/
    ...
    @Override
     ...
     {
      itemIcon = iconRegister.registerIcon(Common.modid +":" + this.getUnlocalizedName().substring(5));
     }
}